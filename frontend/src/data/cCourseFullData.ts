...
const createLesson = (
  ...
  resources: [
    {
      id: `res-${id}-pdf-notes`,
      name: 'C Programming Complete Notes.pdf',
      description: 'The authoritative C language course textbook reference PDF.',
      category: 'PDF',
      fileSize: '2.6 MB',
      downloadPermission: true,
      url: '/c-programming-complete-notes.pdf'
    }
  ]
});
...
export const cCourseModules: ModuleItem[] = [
  {
    id: 'c-mod-1',
    title: 'Module 1: Introduction to C Programming',
    description: 'Introduction to C Programming covering History, Features, First C Program, and Compilation Process.',
    duration: '2 Hours',
    topics: [
      {
        id: 'c-topic-1',
        title: 'Topic 1: Introduction & Compilation',
...
./main`,
  ...
  {
    id: 'c-mod-2',
    title: 'Module 2: Variables, Constants & Data Types',
    description: 'Variables, Constants, Data types (int, float, char, double), Type conversion, and Memory representation.',
    duration: '2 Hours',
    topics: [
      {
        id: 'c-topic-2',
        title: 'Topic 2: Memory & Data Types',
        description: 'Variable declaration, size calculation, type specifiers, and casting.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-2-notes',
            'Module 2 - Complete Notes',
            'Module 2: Variables, Constants & Data Types Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[2]
          )
  ...
  },
  {
    ...
    description: 'Arithmetic, Relational, Logical, Assignment, Increment/Decrement, Bitwise, and Expression Evaluation.',
    duration: '2 Hours',
    topics: [
      {
        id: 'c-topic-3',
        title: 'Topic 3: Operations & Precedence',
        description: 'Arithmetic operations, conditional values, short-circuit, and bitwise evaluation.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-3-notes',
            'Module 3 - Complete Notes',
            'Module 3: Operators & Expressions Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[3]
          )
  ...
  {
    id: 'c-mod-4',
    title: 'Module 4: Input, Output & Decision-Making Statements',
    description: 'printf(), scanf(), formatted I/O, if, if-else, nested conditions, and switch-case control.',
    duration: '2 Hours',
    topics: [
      {
        id: 'c-topic-4',
        title: 'Topic 4: Formatted I/O & Conditions',
        description: 'Input scan logic, format specifiers, decision branches, and switch calculations.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-4-notes',
            'Module 4 - Complete Notes',
            'Module 4: Input, Output & Decision-Making Statements Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[4]
          )
  ...
  },
  {
    ...
    description: 'for, while, do-while, nested loops, break, continue, and pattern flow.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-5',
        title: 'Topic 5: Iterative Control Structures',
        description: 'Entry vs exit controlled loops, infinite loops, and algorithm loops.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-5-notes',
            'Module 5 - Complete Notes',
            'Module 5: Loops & Iteration Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[5]
          )
  ...
  },
  {
    ...
    description: 'Function prototype, definition, calling, parameters, return values, and recursion flow.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-6',
        title: 'Topic 6: Modular Code & Recursion',
        description: 'Passing arguments, function scopes, value copies, and recursive stacks.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-6-notes',
            'Module 6 - Complete Notes',
            'Module 6: Functions Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[6]
          )
  ...
  },
  {
    ...
    description: 'One-dimensional arrays, multi-dimensional (2D) arrays, traversal, searching, and sorting.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-7',
        title: 'Topic 7: Contiguous Storage & Matrices',
        description: 'Array elements access, parameter decay, linear search, and matrix additions.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-7-notes',
            'Module 7 - Complete Notes',
            'Module 7: Arrays Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[7]
          )
  ...
  },
  {
    ...
    description: 'Character arrays, null character terminator, read/write string functions, and manipulations.',
    duration: '2 Hours',
    topics: [
      {
        id: 'c-topic-8',
        title: 'Topic 8: Character Sequences',
        description: 'fgets vs gets, string length, copy, concatenate, and compare utility headers.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-8-notes',
            'Module 8 - Complete Notes',
            'Module 8: Strings Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[8]
          )
  ...
  },
  {
    ...
    description: 'Addresses, dereferencing, pointer variables, arithmetic, pointers vs arrays, and safety.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-9',
        title: 'Topic 9: Memory Addresses & Dereferencing',
        description: 'Accessing memory, variable modification, and swapping simulation.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-9-notes',
            'Module 9 - Complete Notes',
            'Module 9: Pointers Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[9]
          )
  ...
  {
    id: 'c-mod-10',
    title: 'Module 10: Structures, Unions & Enumerations',
    description: 'Structures syntax, member access dot/arrow, unions memory share, enums, and typedef.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-10',
        title: 'Topic 10: User-Defined Data Types',
        description: 'Creating structures, nested types, memory alignment padding, and union values.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-10-notes',
            'Module 10 - Complete Notes',
            'Module 10: Structures, Unions & Enumerations Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[10]
          )
  ...
  {
    id: 'c-mod-11',
    title: 'Module 11: Dynamic Memory Allocation',
    description: 'Stack vs Heap, malloc(), calloc(), realloc(), free(), dynamic arrays, and memory safety.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-11',
        title: 'Topic 11: Runtime Memory Requests',
        description: 'Allocating uninitialized and zeroed bytes, resizing, leaks, and double free bugs.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-11-notes',
            'Module 11 - Complete Notes',
            'Module 11: Dynamic Memory Allocation Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[11]
          )
  ...
  },
  {
    ...
    description: 'FILE pointer streams, fopen(), fclose(), reading/writing text & binary, and EOF checks.',
    duration: '2 Hours',
    topics: [
      {
        id: 'c-topic-12',
        title: 'Topic 12: Disk Storage Persistence',
        description: 'File operations, check methods, read methods, and character counting scripts.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-12-notes',
            'Module 12 - Complete Notes',
            'Module 12: File Handling Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[12]
          )
  ...
  {
    id: 'c-mod-13',
    title: 'Module 13: Preprocessor & Advanced C',
    description: '#include, #define macros, preprocessor directives, conditional compilation, and include guards.',
    duration: '2 Hours',
    topics: [
      {
        id: 'c-topic-13',
        title: 'Topic 13: Compiler Text Substitution',
        description: 'File inclusions, macros, macro parameters, conditional sections, and guards.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-13-notes',
            'Module 13 - Complete Notes',
            'Module 13: Preprocessor & Advanced C Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[13]
          )
  ...
  {
    id: 'c-mod-14',
    title: 'Module 14: Data Structures & C Projects',
    description: 'Linked Lists, Stacks, Queues, Searching/Sorting algorithms, and multi-file projects.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-14',
        title: 'Topic 14: Linear Data Layouts',
        description: 'Node pointers links, LIFO/FIFO queues, selection and insertion sorting, and C projects.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-14-notes',
            'Module 14 - Complete Notes',
            'Module 14: Data Structures & C Projects Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[14]
          )
  ...
  {
    id: 'c-mod-15',
    title: 'Module 15: Advanced C Concepts & Final Revision',
    description: 'Command-line arguments, function pointers, void pointers, bit masking, assert, and UB.',
    duration: '3 Hours',
    topics: [
      {
        id: 'c-topic-15',
        title: 'Topic 15: Low-Level Programming & UB',
        description: 'Argc/argv vector, generic void pointers, bit masking flags, const qualifiers, and UB cases.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'c-unit-15-notes',
            'Module 15 - Complete Notes',
            'Module 15: Advanced C Concepts & Final Revision Complete Notes.',
            '45 mins',
            'Reading',
            cSyllabusNotes[15]
          )
