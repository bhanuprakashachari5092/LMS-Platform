  ...
  resources: [
    {
      ...
      description: 'Comprehensive DSA and algorithmic problem solving guide.',
      category: 'PDF',
      fileSize: '5.2 MB',
      downloadPermission: true,
      url: '/dsa-complete-notes.pdf'
    }
  ]
});

const dsaSyllabusNotes: Record<number, string> = {
  1: `# Module 1: Algorithm Analysis & Big-O Notation
...
export const dsaCourseModules: ModuleItem[] = [
    ...
    topics: [
      {
        ...
        description: 'Orders of growth, worst case, best case, and space analysis.',
  ...
  },
  {
    ...
    topics: [
      {
        id: 'dsa-top-2',
        title: 'Arrays & Two-Pointer Algorithms',
        description: 'Memory layout, two-pointer scan, and sliding window optimization.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-2-notes',
    ...
    topics: [
      {
        ...
        description: 'Pointers, in-place reversal, Floyd cycle detection.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-3-notes',
    ...
    topics: [
      {
        ...
        description: 'LIFO/FIFO evaluation, parenthesis parsing, and queues.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-4-notes',
  ...
  },
  {
    ...
    topics: [
      {
        id: 'dsa-top-5',
        title: 'Recursive Search & Backtracking',
        description: 'Call stack tracing, power set, permutations, and backtracking.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-5-notes',
            'Module 5 - Complete Notes',
            'Recursion, Backtracking & Decision Trees.',
            '45 mins',
            'Reading',
            dsaSyllabusNotes[5]
          )
    ...
    topics: [
      {
        ...
        description: 'Divide-and-conquer, partition algorithms, and binary search.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-6-notes',
            'Module 6 - Complete Notes',
            'Sorting Algorithms & Binary Search Mastery.',
            '45 mins',
            'Reading',
            dsaSyllabusNotes[6]
          )
  ...
  },
  {
    ...
    topics: [
      {
        id: 'dsa-top-7',
        title: 'Hierarchical Tree Structures',
        description: 'Tree recursion, BST search/insert, and traversal algorithms.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-7-notes',
            'Module 7 - Complete Notes',
            'Binary Trees, BST & Tree Traversal.',
            '45 mins',
            'Reading',
            dsaSyllabusNotes[7]
          )
  ...
  },
  {
    ...
    topics: [
      {
        id: 'dsa-top-8',
        title: 'Heap Operations & Priority Queues',
        description: 'Array representation, heapify up/down, and Top-K challenges.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-8-notes',
            'Module 8 - Complete Notes',
            'Binary Heaps & Priority Queue Optimization.',
            '45 mins',
            'Reading',
            dsaSyllabusNotes[8]
          )
  ...
  },
  {
    ...
    topics: [
      {
        id: 'dsa-top-9',
        title: 'Graph Theory & Pathfinding',
        description: 'BFS, DFS, cycle detection, and Dijkstra algorithm.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-9-notes',
            'Module 9 - Complete Notes',
            'Graph Representations, BFS, DFS & Dijkstra.',
            '45 mins',
            'Reading',
            dsaSyllabusNotes[9]
          )
    ...
    topics: [
      {
        ...
        description: 'Overlapping subproblems, state transitions, and tabulation.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'dsa-unit-10-notes',
