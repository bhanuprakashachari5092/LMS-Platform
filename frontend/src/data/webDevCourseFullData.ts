  ...
  resources: [
    {
      ...
      description: 'HTML5, CSS3, JavaScript and responsive web design reference guide.',
      category: 'PDF',
      fileSize: '4.5 MB',
      downloadPermission: true,
      url: '/webdev-complete-notes.pdf'
    }
  ]
});

const webDevSyllabusNotes: Record<number, string> = {
  1: `# Module 1: Introduction to Web Development & How the Web Works
...
export const webDevCourseModules: ModuleItem[] = [
    ...
    topics: [
      {
        ...
        description: 'Client-server architecture, DNS resolution, and HTTP lifecycles.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-1-notes',
            'Module 1 - Complete Notes',
            'Web Architecture & Client-Server Protocols.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[1]
          )
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        id: 'web-top-2',
        title: 'Semantic HTML5 & Accessible Forms',
        description: 'Semantic landmarks, input validations, and ARIA labels.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-2-notes',
            'Module 2 - Complete Notes',
            'Semantic HTML5 & Accessible Web Forms.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[2]
          )
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        id: 'web-top-3',
        title: 'CSS Styling Foundations',
        description: 'The box model, CSS reset, custom properties, and cascading rules.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-3-notes',
            'Module 3 - Complete Notes',
            'CSS3 Box Model & Theming with Variables.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[3]
          )
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        id: 'web-top-4',
        title: 'Responsive Flexbox & Grid Systems',
        description: 'Auto-fit grids, flexible containers, and mobile-first breakpoints.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-4-notes',
  ...
  },
  {
    ...
    topics: [
      {
        id: 'web-top-5',
        title: 'Transitions & Glassmorphic UI',
        description: 'Smooth keyframes, micro-interactions, and glass aesthetics.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-5-notes',
            'Module 5 - Complete Notes',
            'CSS Keyframes, Transitions & Modern Aesthetics.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[5]
          )
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        id: 'web-top-6',
        title: 'Dynamic DOM & User Interactions',
        description: 'Event listeners, accessible dialogs, and interactive widgets.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-6-notes',
    ...
    topics: [
      {
        ...
        description: 'Async data fetching, error handling, and browser storage.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-7-notes',
            'Module 7 - Complete Notes',
            'Fetch API, REST Integration & Local Storage.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[7]
          )
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        id: 'web-top-8',
        title: 'Capstone Website Project',
        description: 'Multi-page architecture, live filters, and state persistence.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-8-notes',
            'Module 8 - Complete Notes',
            'Real-World Full-Featured Web Application Project.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[8]
          )
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        id: 'web-top-9',
        title: 'Performance & Search Engine Optimization',
        description: 'LCP/CLS tuning, lazy loading, Open Graph, and JSON-LD metadata.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-9-notes',
            'Module 9 - Complete Notes',
            'Core Web Vitals, Web Performance & Technical SEO.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[9]
          )
        ]
      }
    ]
  },
  {
    ...
    topics: [
      {
        id: 'web-top-10',
        title: 'Cloud Deployment & Developer Portfolio',
        description: 'CI/CD deployment pipelines, custom domains, and portfolio showcases.',
        estimatedDuration: '45 mins',
        learningUnits: [
          createLesson(
            'web-unit-10-notes',
            'Module 10 - Complete Notes',
            'Web Deployment, Custom Domains & Portfolio Launch.',
            '45 mins',
            'Reading',
            webDevSyllabusNotes[10]
          )
        ]
      }
    ]
