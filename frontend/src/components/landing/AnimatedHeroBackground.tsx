...
export const AnimatedHeroBackground: React.FC = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute -top-12 -left-12 w-80 h-80 sm:w-96 sm:h-96 rounded-full blur-3xl opacity-70 dark:opacity-80 transition-all duration-500 will-change-transform"
        style={{
          background:
      ...
      <div
        className="absolute -top-10 -right-10 w-80 h-80 sm:w-96 sm:h-96 rounded-full blur-3xl opacity-60 dark:opacity-75 transition-all duration-500 will-change-transform"
        style={{
          background:
      ...
      <div
        className="absolute -bottom-16 -left-10 w-80 h-80 sm:w-96 sm:h-96 rounded-full blur-3xl opacity-50 dark:opacity-70 transition-all duration-500 will-change-transform"
        style={{
          background:
      ...
      <div
        className="absolute -bottom-12 -right-12 w-80 h-80 sm:w-96 sm:h-96 rounded-full blur-3xl opacity-50 dark:opacity-65 transition-all duration-500 will-change-transform"
        style={{
          background:
      ...
      <div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 w-full max-w-2xl h-72 rounded-full blur-3xl opacity-30 dark:opacity-40 transition-all duration-500 pointer-events-none"
        style={{
          background:
