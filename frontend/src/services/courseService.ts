...
const DEFAULT_COURSES: ICourse[] = [
  ...
  },
  {
    ...
    title: 'JavaScript',
    slug: 'javascript',
    shortDescription: 'Learn modern JavaScript including variables, functions, arrays, objects, ES6+, asynchronous programming, promises, modules and browser APIs.',
    ...
    banner: 'https://images.unsplash.com/photo-1579468118864-1b9ea3c0db4a?auto=format&fit=crop&w=800&q=80',
    ...
    skills: ['JavaScript', 'ES6+', 'Async/Await', 'DOM Manipulation', 'Event Loop', 'Fetch API', 'Promises'],
    prerequisites: ['Basic computer literacy', 'Basic HTML/CSS understanding'],
    learningOutcomes: [
      'Master core JavaScript fundamentals, variables, and data structures',
      'Understand lexical scope, closures, prototypes, and ES6+ syntax',
      'Manipulate the DOM dynamically and handle browser events',
      'Work with Asynchronous JavaScript, Promises, and REST API fetching'
    ],
    status: 'published',
    visibility: 'public',
    featured: true,
    tags: ['javascript', 'js', 'frontend', 'es6', 'webdev'],
    enrollmentCount: 0,
    rating: 5.0,
    ratingCount: 0,
    syllabus: [
      { id: 'js-mod-1', title: 'Module 1: JavaScript Fundamentals & Syntax', description: 'What is JS, runtime environments, script tags, console, and execution context.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'js-mod-2', title: 'Module 2: Variables, Data Types & Operators', description: 'let, const, var, primitives vs objects, coercion, arithmetic and logical operators.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'js-mod-3', title: 'Module 3: Control Flow & Functions', description: 'Conditionals, loops, function declarations, expressions, arrow functions, and scope.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'js-mod-4', title: 'Module 4: Arrays & Object Manipulation', description: 'Array methods (map, filter, reduce), object destructuring, spread, and rest.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'js-mod-5', title: 'Module 5: DOM & Browser Event Handling', description: 'Selecting elements, modifying attributes, event listeners, and delegation.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'js-mod-6', title: 'Module 6: Asynchronous JavaScript & Promises', description: 'Event loop, callback queue, Promises, async/await, and Fetch API.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'js-mod-7', title: 'Module 7: Modern ES6+ Features & Modules', description: 'Import/export modules, template literals, optional chaining, and nullish coalescing.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'js-mod-8', title: 'Module 8: Object-Oriented JS & Prototypes', description: 'Classes, constructors, inheritance, prototype chain, and this keyword.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'js-mod-9', title: 'Module 9: Practical JavaScript Projects', description: 'Interactive Quiz app, Weather Dashboard, and Task Management system.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'js-mod-10', title: 'Module 10: JavaScript Interview Mastery', description: 'Hoisting, closures, currying, event bubbling, and top technical interview Q&A.', duration: '2 Hours', lessonsCount: 1 }
    ],
    modules: [],
  ...
  },
  {
    ...
    title: 'Node.js',
    slug: 'nodejs',
    shortDescription: 'Learn backend development with Node.js, Express, REST APIs, authentication, middleware, databases and production backend patterns.',
    ...
    banner: 'https://images.unsplash.com/photo-1627398242454-45a1465c2479?auto=format&fit=crop&w=800&q=80',
    ...
    skills: ['Node.js', 'Express.js', 'REST APIs', 'JWT Authentication', 'MongoDB & SQL', 'Middleware Architecture', 'Error Handling'],
    prerequisites: ['Solid JavaScript fundamentals', 'Basic HTTP knowledge'],
    learningOutcomes: [
      'Understand the Node.js runtime, Event Loop, and non-blocking I/O architecture',
      'Build robust RESTful API servers using Express.js and middleware',
      'Implement secure user authentication with JWT and bcrypt',
      'Connect databases and deploy production-ready backend applications'
    ],
    status: 'published',
    visibility: 'public',
    featured: true,
    ...
    ratingCount: 0,
    syllabus: [
      { id: 'node-mod-1', title: 'Module 1: Introduction to Node.js & V8 Engine', description: 'Node runtime, V8 architecture, REPL, and executing scripts.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'node-mod-2', title: 'Module 2: Node Modules, NPM & File System', description: 'CommonJS vs ES Modules, fs module, path, and package management.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'node-mod-3', title: 'Module 3: Asynchronous Programming & Event Loop', description: 'Event emitter, buffer, streams, and non-blocking I/O lifecycle.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'node-mod-4', title: 'Module 4: Express.js Framework & Routing', description: 'Express setup, routing, URL parameters, and query strings.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'node-mod-5', title: 'Module 5: Middleware & Request Processing', description: 'Built-in, third-party, and custom middleware patterns.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'node-mod-6', title: 'Module 6: RESTful API Design & Validation', description: 'HTTP verbs, status codes, JSON responses, and input validation with Zod/Joi.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'node-mod-7', title: 'Module 7: Database Integration (SQL & MongoDB)', description: 'Connecting PostgreSQL and MongoDB, ORMs, and CRUD operations.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'node-mod-8', title: 'Module 8: Authentication, Authorization & JWT', description: 'Password hashing with bcrypt, JWT token generation, and protected routes.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'node-mod-9', title: 'Module 9: Error Handling, Logging & Security', description: 'Global error handlers, Winston/Morgan logging, CORS, Helmet, and rate limiting.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'node-mod-10', title: 'Module 10: Production Backend Project & Deployment', description: 'Building and deploying a production-ready E-commerce REST API backend.', duration: '3 Hours', lessonsCount: 1 }
    ],
    modules: [],
    createdAt: new Date('2026-08-13').toISOString(),
    updatedAt: new Date('2026-08-13').toISOString(),
  },
  {
    id: 'data-structures-and-algorithms',
    title: 'Data Structures & Algorithms',
    slug: 'data-structures-and-algorithms',
    shortDescription: 'Learn arrays, linked lists, stacks, queues, trees, graphs, sorting, searching, recursion and algorithmic problem solving.',
    ...
    banner: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=800&q=80',
    ...
    skills: ['Arrays & Strings', 'Linked Lists', 'Stacks & Queues', 'Binary Trees', 'Graphs & Traversal', 'Sorting & Searching', 'Dynamic Programming'],
    prerequisites: ['Proficiency in at least one programming language (C, Java, Python, or JavaScript)'],
    learningOutcomes: [
      'Analyze time and space complexity using Big-O notation',
      'Master core linear and non-linear data structures from scratch',
      'Implement key searching, sorting, and graph traversal algorithms',
      'Solve complex algorithmic problems for technical interviews'
    ],
    status: 'published',
    visibility: 'public',
    featured: true,
    tags: ['dsa', 'algorithms', 'datastructures', 'interviews', 'problemsolving'],
    enrollmentCount: 0,
    rating: 5.0,
    ratingCount: 0,
    syllabus: [
      { id: 'dsa-mod-1', title: 'Module 1: Algorithm Analysis & Big-O Notation', description: 'Time complexity, space complexity, asymptotic notation, and analysis.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-2', title: 'Module 2: Arrays & Two-Pointer Techniques', description: 'Array manipulations, sliding window, prefix sums, and binary search.', duration: '4 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-3', title: 'Module 3: Linked Lists (Singly & Doubly)', description: 'Node structure, insertion, deletion, reversal, cycle detection, and merge.', duration: '4 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-4', title: 'Module 4: Stacks & Queues', description: 'LIFO/FIFO principles, balanced parentheses, monotonic stack, and circular queue.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-5', title: 'Module 5: Recursion & Backtracking', description: 'Base cases, recursive trees, permutations, subsets, and N-Queens problem.', duration: '4 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-6', title: 'Module 6: Sorting & Searching Algorithms', description: 'Merge sort, quick sort, heap sort, linear search, and binary search variants.', duration: '4 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-7', title: 'Module 7: Binary Trees & BST', description: 'Tree traversals (Inorder, Preorder, Postorder, Level order), BST ops, and LCA.', duration: '5 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-8', title: 'Module 8: Heaps & Priority Queues', description: 'Min-heap, max-heap, heapify algorithm, and Top-K elements problems.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-9', title: 'Module 9: Graphs & Graph Traversals', description: 'Adjacency list/matrix, BFS, DFS, Dijkstra shortest path, and topological sort.', duration: '5 Hours', lessonsCount: 1 },
      { id: 'dsa-mod-10', title: 'Module 10: Dynamic Programming & Greedy Algorithms', description: 'Memoization, tabulation, knapsack problem, LCS, and greedy optimization.', duration: '5 Hours', lessonsCount: 1 }
    ],
    modules: [],
  ...
  },
  {
    ...
    shortDescription: 'Learn HTML, CSS and JavaScript fundamentals and build responsive modern web applications.',
    ...
    skills: ['HTML5 Semantic Elements', 'CSS3 Flexbox & Grid', 'Responsive Web Design', 'JavaScript Interactivity', 'Git & Deployment', 'Web Accessibility'],
    prerequisites: ['No prior programming experience required'],
    learningOutcomes: [
      'Write clean, accessible, and semantic HTML5 documents',
      'Design modern, responsive user interfaces with CSS3, Flexbox, and Grid',
      'Add dynamic client-side interactivity using modern JavaScript',
      'Build and deploy complete real-world responsive website projects'
    ],
    status: 'published',
    visibility: 'public',
    featured: true,
    tags: ['webdevelopment', 'html', 'css', 'javascript', 'frontend', 'responsive'],
    enrollmentCount: 0,
    rating: 5.0,
    ratingCount: 0,
    syllabus: [
      { id: 'web-mod-1', title: 'Module 1: Introduction to Web Development', description: 'How the Web works, browsers, servers, HTTP, and developer tools.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'web-mod-2', title: 'Module 2: HTML5 Semantic Structure & Forms', description: 'Tags, semantic elements, tables, media elements, and accessible forms.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'web-mod-3', title: 'Module 3: CSS3 Styling & Box Model', description: 'Selectors, box model, margins, padding, borders, colors, and typography.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'web-mod-4', title: 'Module 4: Responsive Design with Flexbox & Grid', description: 'Flex container, flex items, CSS Grid layouts, and media queries.', duration: '4 Hours', lessonsCount: 1 },
      { id: 'web-mod-5', title: 'Module 5: CSS Animations & Modern Layouts', description: 'Transitions, keyframe animations, glassmorphism, and modern UI tokens.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'web-mod-6', title: 'Module 6: JavaScript for Web Interactivity', description: 'DOM manipulation, click events, form validation, and interactive menus.', duration: '4 Hours', lessonsCount: 1 },
      { id: 'web-mod-7', title: 'Module 7: Working with Web APIs & Data Fetching', description: 'Fetch API, async/await, JSON parsing, and displaying remote data.', duration: '3 Hours', lessonsCount: 1 },
      { id: 'web-mod-8', title: 'Module 8: Building a Real-World Website Project', description: 'End-to-end multi-page responsive company landing page project.', duration: '4 Hours', lessonsCount: 1 },
      { id: 'web-mod-9', title: 'Module 9: Web Performance & SEO Optimization', description: 'Lighthouse scoring, image optimization, meta tags, and accessibility.', duration: '2 Hours', lessonsCount: 1 },
      { id: 'web-mod-10', title: 'Module 10: Hosting, Deployment & Portfolio Building', description: 'Deploying with Netlify/Vercel, custom domains, and portfolio presentation.', duration: '2 Hours', lessonsCount: 1 }
    ],
    modules: [],
