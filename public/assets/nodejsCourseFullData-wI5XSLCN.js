var e=(e,t,n,r,i,a,o,s,c,l)=>({id:e,title:t,description:n,duration:r,type:i,readingContent:a,practiceLabChallenge:void 0,codeExamples:o,keyPoints:s,practiceQuestions:c?.map((t,n)=>({id:`pq-${e}-${n}`,...t})),resourceLinks:l?.map((t,n)=>({id:`res-${e}-${n}`,...t})),resources:[{id:`res-${e}-pdf-notes`,name:`Node.js Backend Development Notes.pdf`,description:`Comprehensive Node.js & Express reference guide.`,category:`PDF`,fileSize:`4.8 MB`,downloadPermission:!0,url:`/nodejs-complete-notes.pdf`}]}),t={1:`# Module 1: Introduction to Node.js & V8 Engine
...
\`\`\`
`},n=[{id:`node-mod-1`,title:`Module 1: Introduction to Node.js & V8 Engine`,description:`Node runtime, V8 architecture, REPL, and executing scripts.`,duration:`2 Hours`,topics:[{id:`node-top-1`,title:`Node.js Fundamentals & Architecture`,description:`V8 engine, libuv, thread pool, and non-blocking I/O.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-1-notes`,`Module 1 - Complete Notes`,`Node.js Fundamentals & V8 Architecture.`,`45 mins`,`Reading`,t[1])]}]},{id:`node-mod-2`,title:`Module 2: Node Modules, NPM & File System`,description:`CommonJS vs ES Modules, fs module, path, and package management.`,duration:`3 Hours`,topics:[{id:`node-top-2`,title:`Modules & File I/O`,description:`File reading, writing, path resolution, and NPM workflows.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-2-notes`,`Module 2 - Complete Notes`,`Node Modules, NPM & File System I/O.`,`45 mins`,`Reading`,t[2])]}]},{id:`node-mod-3`,title:`Module 3: Asynchronous Programming & Event Loop`,description:`Event emitter, buffer, streams, and non-blocking I/O lifecycle.`,duration:`3 Hours`,topics:[{id:`node-top-3`,title:`Event Loop & Streams`,description:`Phases of event loop, EventEmitter, and streams.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-3-notes`,`Module 3 - Complete Notes`,`Event Loop Mechanics & Asynchronous Architecture.`,`45 mins`,`Reading`,t[3])]}]},{id:`node-mod-4`,title:`Module 4: Express.js Framework & Routing`,description:`Express setup, routing, URL parameters, and query strings.`,duration:`3 Hours`,topics:[{id:`node-top-4`,title:`Express Server & Routes`,description:`HTTP methods, parameters, and query parsing.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-4-notes`,`Module 4 - Complete Notes`,`Express.js Framework & Routing Architecture.`,`45 mins`,`Reading`,t[4])]}]},{id:`node-mod-5`,title:`Module 5: Middleware & Request Processing`,description:`Built-in, third-party, and custom middleware patterns.`,duration:`3 Hours`,topics:[{id:`node-top-5`,title:`Middleware Pipelines`,description:`Creating custom logging, timing, and authentication middleware.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-5-notes`,`Module 5 - Complete Notes`,`Express Middleware & Request Processing Pipelines.`,`45 mins`,`Reading`,t[5])]}]},{id:`node-mod-6`,title:`Module 6: RESTful API Design & Validation`,description:`HTTP verbs, status codes, JSON responses, and input validation with Zod.`,duration:`3 Hours`,topics:[{id:`node-top-6`,title:`REST Architecture & Zod`,description:`REST principles, status codes, and schema validation.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-6-notes`,`Module 6 - Complete Notes`,`REST API Design & Schema Validation.`,`45 mins`,`Reading`,t[6])]}]},{id:`node-mod-7`,title:`Module 7: Database Integration (SQL & MongoDB)`,description:`Connecting PostgreSQL and MongoDB, ORMs, and CRUD operations.`,duration:`3 Hours`,topics:[{id:`node-top-7`,title:`Database Persistence`,description:`PostgreSQL pools, parameterized queries, and MongoDB schemas.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-7-notes`,`Module 7 - Complete Notes`,`Database Connections & Parameterized Queries.`,`45 mins`,`Reading`,t[7])]}]},{id:`node-mod-8`,title:`Module 8: Authentication, Authorization & JWT`,description:`Password hashing with bcrypt, JWT token generation, and protected routes.`,duration:`3 Hours`,topics:[{id:`node-top-8`,title:`Security & Auth Middleware`,description:`JWT issuance, bcrypt salting, and role-based guards.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-8-notes`,`Module 8 - Complete Notes`,`JWT Authentication & RBAC Authorization.`,`45 mins`,`Reading`,t[8])]}]},{id:`node-mod-9`,title:`Module 9: Error Handling, Logging & Security`,description:`Global error handlers, Winston logging, CORS, Helmet, and rate limiting.`,duration:`2 Hours`,topics:[{id:`node-top-9`,title:`Production Resilience & Hardening`,description:`Central error handlers, rate limiting, and security headers.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-9-notes`,`Module 9 - Complete Notes`,`Error Boundaries, Winston Logging & Security Hardening.`,`45 mins`,`Reading`,t[9])]}]},{id:`node-mod-10`,title:`Module 10: Production Backend Project & Deployment`,description:`Building and deploying a production-ready REST API backend.`,duration:`3 Hours`,topics:[{id:`node-top-10`,title:`Production Deployment & PM2`,description:`Graceful shutdown, PM2 clustering, and containerization.`,estimatedDuration:`45 mins`,learningUnits:[e(`node-unit-10-notes`,`Module 10 - Complete Notes`,`Production Architecture & Graceful Shutdown.`,`45 mins`,`Reading`,t[10])]}]}];export{n as nodejsCourseModules};