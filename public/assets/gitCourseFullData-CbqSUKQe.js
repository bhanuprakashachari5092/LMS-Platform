var e=[{id:`git-mod-1`,title:`Module 1: Introduction to Version Control, Git & GitHub`,description:`Introduction to Version Control, Git & GitHub`,duration:`1 Hour`,topics:[{id:`git-topic-1`,title:`Topic 1: Module 1 Content`,description:`Module 1 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-1-notes`,title:`Module 1 - Complete Notes`,description:`Module 1: Introduction to Version Control, Git & GitHub Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
merging capabilities, and better collaboration, making it the preferred choice for modern software development. Practical Lab Task 1 Research three popular Version Control Systems (Git, SVN, Mercurial) and compare their features. Task 2 Draw the architecture of Git. Task 3 List five advantages of using Git in software development. Task 4 Write five differences between Git and GitHub. Task 5 Describe a real-world software development workflow using Git and GitHub.`}]}]},{id:`git-mod-2`,title:`Module 2: Installing Git and Initial Configuration`,description:`Installing Git and Initial Configuration`,duration:`1 Hour`,topics:[{id:`git-topic-2`,title:`Topic 2: Module 2 Content`,description:`Module 2 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-2-notes`,title:`Module 2 - Complete Notes`,description:`Module 2: Installing Git and Initial Configuration Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
Task 3 Configure your Git username and email. Task 4 Create a folder named GitPractice and initialize it as a Git repository. Task 5 Use git config --list to verify your configuration.`}]}]},{id:`git-mod-3`,title:`Module 3: Git Repository Fundamentals`,description:`Git Repository Fundamentals`,duration:`1 Hour`,topics:[{id:`git-topic-3`,title:`Topic 3: Module 3 Content`,description:`Module 3 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-3-notes`,title:`Module 3 - Complete Notes`,description:`Module 3: Git Repository Fundamentals Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
Practical Lab Task 1 Initialize a new Git repository using git init. Task 2 Locate and inspect the hidden .git directory. Task 3 Create three files and observe their state using git status. Task 4 Draw the Git workflow showing the Working Directory, Staging Area, Local Repository, and Remote Repository. Task 5 Explain the purpose of the four Git objects (Blob, Tree, Commit, Tag) with examples.`}]}]},{id:`git-mod-4`,title:`Module 4: Basic Git Commands`,description:`Basic Git Commands`,duration:`1 Hour`,topics:[{id:`git-topic-4`,title:`Topic 4: Module 4 Content`,description:`Module 4 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-4-notes`,title:`Module 4 - Complete Notes`,description:`Module 4: Basic Git Commands Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
git log --oneline
\`\`\`
`}]}]},{id:`git-mod-5`,title:`Module 5: Branching and Merging`,description:`Branching and Merging`,duration:`1 Hour`,topics:[{id:`git-topic-5`,title:`Topic 5: Module 5 Content`,description:`Module 5 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-5-notes`,title:`Module 5 - Complete Notes`,description:`Module 5: Branching and Merging Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
Practical Lab Task 1 Create a new branch named feature/profile. Task 2 Switch to the new branch. Task 3 Make a small file change and commit it. Task 4 Merge the feature/profile branch into the main branch. Task 5 Delete the merged branch and verify it no longer appears in the branch list.`}]}]},{id:`git-mod-6`,title:`Module 6: GitHub Basics`,description:`GitHub Basics`,duration:`1 Hour`,topics:[{id:`git-topic-6`,title:`Topic 6: Module 6 Content`,description:`Module 6 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-6-notes`,title:`Module 6 - Complete Notes`,description:`Module 6: GitHub Basics Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
Practical Lab Task 1 Create a GitHub account. Task 2 Create a new public repository named GitPractice. Task 3 Connect your local repository to GitHub using git remote add origin. Task 4 Push your first commit to GitHub. Task 5 Clone your repository into a different folder and verify that all files are downloaded.`}]}]},{id:`git-mod-7`,title:`Module 7: Remote Repository Management`,description:`Remote Repository Management`,duration:`1 Hour`,topics:[{id:`git-topic-7`,title:`Topic 7: Module 7 Content`,description:`Module 7 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-7-notes`,title:`Module 7 - Complete Notes`,description:`Module 7: Remote Repository Management Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
Task 3 Push your local repository to GitHub. Task 4 Use git fetch to retrieve updates without merging them. Task 5 Configure an upstream branch and test simple git push and git pull commands.`}]}]},{id:`git-mod-8`,title:`Module 8: Git Collaboration`,description:`Git Collaboration`,duration:`1 Hour`,topics:[{id:`git-topic-8`,title:`Topic 8: Module 8 Content`,description:`Module 8 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-8-notes`,title:`Module 8 - Complete Notes`,description:`Module 8: Git Collaboration Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
- Squash Merge
- Rebase and Merge
Each strategy has different effects on the project's commit history. Practical Lab Task 1 Clone a GitHub repository. Task 2 Create a feature branch named feature/profile. Task 3 Make changes, commit them, and push the branch to GitHub. Task 4 Create a Pull Request from feature/profile to main. Task 5 Review the Pull Request, merge it, and delete the feature branch.`}]}]},{id:`git-mod-9`,title:`Module 9: Advanced Git Commands`,description:`Advanced Git Commands`,duration:`1 Hour`,topics:[{id:`git-topic-9`,title:`Topic 9: Module 9 Content`,description:`Module 9 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-9-notes`,title:`Module 9 - Complete Notes`,description:`Module 9: Advanced Git Commands Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
Answer: A Git Tag is a reference used to mark important points in a repository's history, such as software releases (e.g., v1.0, v2.0). Practical Lab Task 1 Create a temporary change and save it using git stash. Task 2 Restore the saved work using git stash pop. Task 3 Create an annotated tag named v1.0. Task 4 Use git cherry-pick to apply a commit from another branch. Task 5 Compare the output of git merge and git rebase using a sample repository.`}]}]},{id:`git-mod-10`,title:`Module 10: Git Internals`,description:`Git Internals`,duration:`1 Hour`,topics:[{id:`git-topic-10`,title:`Topic 10: Module 10 Content`,description:`Module 10 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-10-notes`,title:`Module 10 - Complete Notes`,description:`Module 10: Git Internals Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
Practical Lab Task 1 Initialize a Git repository and locate the hidden .git directory. Task 2 Create a file, commit it, and observe the repository structure. Task 3 Create an annotated tag named v1.0. Task 4 Draw the relationship between Blob, Tree, and Commit objects. Task 5 Explain the purpose of HEAD, Refs, and the Index in your own words.`}]}]},{id:`git-mod-11`,title:`Module 11: GitHub Features`,description:`GitHub Features`,duration:`1 Hour`,topics:[{id:`git-topic-11`,title:`Topic 11: Module 11 Content`,description:`Module 11 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-11-notes`,title:`Module 11 - Complete Notes`,description:`Module 11: GitHub Features Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
- Review
- Done
Task 4 Create a Wiki page named Installation Guide . Task 5 Create a release named v1.0.0 with release notes`}]}]},{id:`git-mod-12`,title:`Module 12: Git Best Practices`,description:`Git Best Practices`,duration:`1 Hour`,topics:[{id:`git-topic-12`,title:`Topic 12: Module 12 Content`,description:`Module 12 Content`,estimatedDuration:`45 mins`,learningUnits:[{id:`git-unit-12-notes`,title:`Module 12 - Complete Notes`,description:`Module 12: Git Best Practices Complete Notes.`,duration:`45 mins`,type:`Reading`,readingContent:`
...
- Pinned repositories.
- README files.
- Portfolio projects.`}]}]}];export{e as gitCourseModules};