var e=(e,t,n,r,i,a,o,s,c,l)=>({id:e,title:t,description:n,duration:r,type:i,readingContent:a,practiceLabChallenge:void 0,codeExamples:o,keyPoints:s,practiceQuestions:c?.map((t,n)=>({id:`pq-${e}-${n}`,...t})),resourceLinks:l?.map((t,n)=>({id:`res-${e}-${n}`,...t})),resources:[{id:`res-${e}-pdf-notes`,name:`DBMS Complete Notes.pdf`,description:`Database Management Systems & SQL Complete Notes.`,category:`PDF`,fileSize:`4.9 MB`,downloadPermission:!0,url:`/dbms-complete-notes.pdf`}]}),t={1:`# Module 1: Introduction to DBMS & Relational Model
...
COMMIT;
\`\`\`
`},n=[{id:`dbms-mod-1`,title:`Module 1: Introduction to DBMS & Relational Model`,description:`DBMS fundamentals, 3-tier architecture, and relational concepts.`,duration:`4 Hours`,topics:[{id:`dbms-top-1`,title:`Data, DBMS & Relational Architecture`,description:`Data vs information, metadata, file systems vs DBMS, and ANSI-SPARC architecture.`,estimatedDuration:`45 mins`,learningUnits:[e(`dbms-unit-1-notes`,`Module 1 - Complete Notes`,`DBMS Architecture & Relational Data Model.`,`45 mins`,`Reading`,t[1])]}]},{id:`dbms-mod-2`,title:`Module 2: SQL Fundamentals & Data Definition Language`,description:`DDL commands, CREATE, ALTER, DROP, constraints, and data types.`,duration:`4 Hours`,topics:[{id:`dbms-top-2`,title:`DDL & Schema Constraints`,description:`Creating tables, foreign keys, cascade deletes, and constraints.`,estimatedDuration:`45 mins`,learningUnits:[e(`dbms-unit-2-notes`,`Module 2 - Complete Notes`,`SQL DDL & Relational Schema Constraints.`,`45 mins`,`Reading`,t[2])]}]},{id:`dbms-mod-3`,title:`Module 3: Data Manipulation Language & Basic Queries`,description:`INSERT, UPDATE, DELETE, filtering, aggregation, and grouping.`,duration:`4 Hours`,topics:[{id:`dbms-top-3`,title:`DML, WHERE & Aggregations`,description:`CRUD operations, aggregate functions, and GROUP BY / HAVING.`,estimatedDuration:`45 mins`,learningUnits:[e(`dbms-unit-3-notes`,`Module 3 - Complete Notes`,`SQL DML, Filtering, Aggregations & Grouping.`,`45 mins`,`Reading`,t[3])]}]},{id:`dbms-mod-4`,title:`Module 4: Relational JOINs & Complex Subqueries`,description:`INNER, LEFT, RIGHT, FULL OUTER joins, nested and correlated subqueries.`,duration:`5 Hours`,topics:[{id:`dbms-top-4`,title:`SQL JOINs & Subquery Patterns`,description:`Joining multiple tables, subqueries, and set operations.`,estimatedDuration:`50 mins`,learningUnits:[e(`dbms-unit-4-notes`,`Module 4 - Complete Notes`,`Relational JOINs, Outer Joins & Subqueries.`,`50 mins`,`Reading`,t[4])]}]},{id:`dbms-mod-5`,title:`Module 5: Database Normalization (1NF, 2NF, 3NF, BCNF)`,description:`Functional dependencies, decomposing anomalies, and normal forms.`,duration:`5 Hours`,topics:[{id:`dbms-top-5`,title:`Normalization Principles & Normal Forms`,description:`1NF, 2NF, 3NF, BCNF decomposition and dependency preservation.`,estimatedDuration:`50 mins`,learningUnits:[e(`dbms-unit-5-notes`,`Module 5 - Complete Notes`,`Database Normalization & Functional Dependencies.`,`50 mins`,`Reading`,t[5])]}]},{id:`dbms-mod-6`,title:`Module 6: Transactions, ACID & Concurrency Control`,description:`ACID transactions, locking protocols, deadlocks, and isolation levels.`,duration:`4 Hours`,topics:[{id:`dbms-top-6`,title:`Transactions & ACID Guarantees`,description:`Transaction isolation levels, WAL logs, and concurrency control.`,estimatedDuration:`45 mins`,learningUnits:[e(`dbms-unit-6-notes`,`Module 6 - Complete Notes`,`Database Transactions, ACID & Concurrency.`,`45 mins`,`Reading`,t[6])]}]}];export{n as dbmsCourseModules};